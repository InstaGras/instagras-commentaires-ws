...
//POST
myRouter.route('/commentairesws/create/')
.post(function(req,response){
	routes.createCommentaire(req,response,client);
});

// GET
myRouter.route('/commentairesws/commentaires/:id')
.get(function(req, response){
	routes.getCommentairesOfPublication(req, response, client);
})

// DELETE
myRouter.route('/commentairesws/commentaires/')
.delete(function(req,response){
	routes.deleteCommentaireById(req,response,client);
})
